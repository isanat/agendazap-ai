...
// Parse functions (parseBookingCommand, parseCancelCommand, parseRescheduleCommand)
// and cancel/reschedule operations are now imported from @/lib/services/booking.service
