...
async function initialize() {
  ...
  const plans = [
    ...
    },
    {
      ...
      maxClients: 5000,
      features: ['whatsapp', 'appointments', 'clients', 'ai', 'reports', 'googleCalendar', 'mercadoPago'],
      isActive: true,
      sortOrder: 3,
    },
    {
      ...
      maxClients: -1,
      features: ['whatsapp', 'appointments', 'clients', 'ai', 'reports', 'googleCalendar', 'mercadoPago', 'nfse', 'api'],
      isActive: true,
      sortOrder: 4,
    },
  ];
